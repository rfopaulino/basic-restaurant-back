...
using System;
using static Interface.Ninject.Activators;

namespace Interface.Ninject
{
    public static class AspNetCoreExtensions
    {
            ...
            Func<Type, object> activator)
        {
            ...
            services.AddSingleton<IViewComponentActivator>(new
                DelegatingViewComponentActivator(activator));
        }
    }
}
